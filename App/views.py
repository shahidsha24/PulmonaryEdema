...
def Deploy_8(request): 
    ...
    if request.method == "POST":
        ...
        models = keras.models.load_model('C:/Users/shahi/Music/B1681 DONE/CODE/Deploy/Project/App/keras_model.h5')
        data = np.ndarray(shape=(1, 224, 224, 3), dtype=np.float32)
        image = Image.open("C:/Users/shahi/Music/B1681 DONE/CODE/Deploy/Project/media/" + str(result1)).convert("RGB")
        size = (224, 224)
        image = ImageOps.fit(image, size, Image.ANTIALIAS)
        image_array = np.asarray(image)
        normalized_image_array = (image_array.astype(np.float32) / 127.0) - 1
        data[0] = normalized_image_array
        classes = ["bat","cephalization","cuffing","effusion","infiltrate","kerley"]
        prediction = models.predict(data)
        idd = np.argmax(prediction)
        a = (classes[idd])
        if a == "bat":
            b ='This Image Detected bat'
        elif a == "cephalization":
            b ='This Image Detected cephalization'
        elif a == "cuffing":
            b ='This Image Detected cuffing'
        elif a == "effusion":
            b ='This Image Detected effusion'
        elif a == "infiltrate":
            b ='This Image Detected infiltrate'
        elif a == "kerley":
            b ='This Image Detected kerley'
